...
<body>
<img src="<?=BASE_URL?>static/logo.png" alt="swipecards" />
<h1>SwipeCards</h1>
...
<p>SwipeCards is a collection of ridiculously simple browser-based flashcards. Just use the arrow keys, control pad, or swipe to advance through the deck. Decks can be "shuffled" or kept in order. They don't keep score, and they don't tell you if you're right or not, because they're not meant as a game. They are meant as a tool for parents and educators to use <em>with</em> a child.</p>
<?
...
?>
<div>
<small>Powered by <a class="remote" href="http://siege.org" target="_blank">Siege (dot) Org</a> using <a class="remote" href="http://revealjs.com" target="_blank">reveal.js</a> and <a class="remote" href="http://mathscribe.com/author/jqmath.html" target="_blank">jqMath</a></small>
</div>
<script>
